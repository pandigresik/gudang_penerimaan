    ...
    @endpush
     <div class="container-fluid">
          <div class="animated fadeIn">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        {!! Form::open(['route' => 'warehouse.sampleClassifications.store']) !!}
                        <div class="card">
                            ...
                            <div class="card-body">                                
                                   ...
                                   @include('warehouse.good_receipt_item_sample_classifications.fields')
                            ...
                            <div class="card-footer">
                                ...
                                <div class="form-group col-sm-12 mt-2">
                                    ...
                                    <a href="{{ route('warehouse.sampleClassifications.index') }}" class="btn btn-default">@lang('crud.cancel')</a>
                                </div>
                            </div>
                        </div>
                        {!! Form::close() !!}
